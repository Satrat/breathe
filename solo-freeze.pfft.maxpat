...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 461.0, 172.0, 196.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 502.0, 194.0, 196.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 502.0, 216.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "frameaccum~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 461.0, 238.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "poltocar~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 461.0, 270.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "fftout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 158.0, 201.0, 124.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 158.0, 253.0, 255.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 275.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "out 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 263.0, 179.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "phasewrap~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 263.0, 157.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "framedelta~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 174.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "prepend dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 123.0, 110.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.0, 86.0, 59.5, 22.0 ],
					"style" : "",
					"text" : "fftinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 158.0, 124.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 158.0, 86.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "fftin~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 86.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "in 1"
				}
